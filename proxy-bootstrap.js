...
const {
  bootstrap,
} = require("/Users/aihacker/.nvm/versions/node/v24.12.0/lib/node_modules/global-agent"); //get using npm root -g
bootstrap();
...
try {
  ...
  setGlobalDispatcher(
    new ProxyAgent({
      uri: proxyUrl,
      allowH2: true, // Handle HTTP/2 responses from Burp MitM
      requestTls: {
        allowH2: true, // Allow H2 ALPN negotiation so buildConnector accepts h2
      },
    }),
  );
